...
## URGENTE: Correção Definitiva de Timezone
- [x] Consultar banco para ver valor exato do evento "Teste de Eventos" (criado às 03:00, aparece 00:52)
- [x] Identificar onde ocorre conversão de -2h08min - Backend interpretava como horário do servidor (GMT-0500)
- [x] Corrigir backend/frontend para salvar e exibir horário literal - Adicionado 'Z' para forçar UTC
- [ ] Testar com novo evento
- [x] Criar script para corrigir horários de eventos antigos
- [x] Executar script de migração - 2 eventos corrigidos
